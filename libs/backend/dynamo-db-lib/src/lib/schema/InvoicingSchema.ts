...
export const InvoicingSchema = {
    ...
    models: {
        Invoice: {
            ...
            status: { type: String, enum: ['ACTIVE', 'FOR_APPROVAL', 'FOR_DELETION', 'NEW_RECORD'], required: false },
            invoiceStatus: { type: String, enum: ['DRAFT', 'COMPLETED'], required: false },
            ...
            GSI13PK: { type: String, value: 'INVOICE#${invoiceStatus}', hidden: false },
