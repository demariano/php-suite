...
export class DenyProductCategoryDto {
    @ApiProperty({
        description: 'Reason for denying the product category record',
        example: 'Product category information is incomplete or incorrect',
        minLength: 3,
    })
