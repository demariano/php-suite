...
import { Customers, Dashboard, File, Groups, Inventory, Products, Reports, Settings } from '@components-web/icons';
        ...
        <div className="navigation-container">
            {navigationModules.map((module) => (
                <div key={module.sectionTitle} className="navigation-module">
                    <div className="navigation-module-header" onClick={() => toggleSection(module.sectionTitle)}>
