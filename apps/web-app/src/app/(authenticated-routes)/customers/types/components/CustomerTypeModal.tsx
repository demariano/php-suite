      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            {isCreateMode ? 'Create Customer Type' : 'Edit Customer Type'}
          </h2>
          <button
            onClick={onClose}
            style={{
        ...
        <div>
          ...
          {activeTab === 'approval' && !isCreateMode && selectedCustomerType && (
            <div>
              <div className="mb-5">
                {(selectedCustomerType.status === StatusEnum.FOR_APPROVAL || selectedCustomerType.status === StatusEnum.NEW_RECORD) && (
                ...
                {selectedCustomerType?.forApprovalVersion ? (
                  <div style={{
                    ...
                    {/* Customer Type Name */}
                    {selectedCustomerType.forApprovalVersion.customerTypeName !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        ...
                        <input
                          type="text"
                          value={String(selectedCustomerType.forApprovalVersion.customerTypeName)}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {/* Status */}
                    {selectedCustomerType.forApprovalVersion.status !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        <label style={{
                          display: 'block',
                          fontSize: '14px',
                        ...
                        <input
                          type="text"
                          value={String(selectedCustomerType.forApprovalVersion.status)}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {Object.entries(selectedCustomerType.forApprovalVersion).map(([key, value]) => {
                      // Skip the fields we've already handled
                      if (key === 'customerTypeName' || key === 'status') {
                        return null;
                      }
