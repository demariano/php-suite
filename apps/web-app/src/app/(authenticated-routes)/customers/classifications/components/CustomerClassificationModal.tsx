...
import CustomerClassificationForm from './CustomerClassificationForm';

interface CustomerClassificationModalProps {
  show: boolean;
...
export default function CustomerClassificationModal({
  show,
  isCreateMode,
  ...
  onApprove,
  onDeny
}: CustomerClassificationModalProps) {
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            {isCreateMode ? 'Create Customer Classification' : 'Edit Customer Classification'}
          </h2>
          <button
            onClick={onClose}
            style={{
        ...
        <div>
          ...
          {activeTab === 'approval' && !isCreateMode && selectedCustomerClassification && (
            <div>
              <div className="mb-5">
                ...
                {selectedCustomerClassification?.forApprovalVersion ? (
                  <div style={{
                    ...
                    {selectedCustomerClassification.forApprovalVersion.customerClassificationName !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        ...
                        <input
                          type="text"
                          value={String(selectedCustomerClassification.forApprovalVersion.customerClassificationName)}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {/* Status */}
                    {selectedCustomerClassification.forApprovalVersion.status !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        <label style={{
                          display: 'block',
                          fontSize: '14px',
                        ...
                        <input
                          type="text"
                          value={String(selectedCustomerClassification.forApprovalVersion.status)}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {Object.entries(selectedCustomerClassification.forApprovalVersion).map(([key, value]) => {
                      // Skip the fields we've already handled
                      if (key === 'customerClassificationName' || key === 'status') {
                        return null;
                      }
