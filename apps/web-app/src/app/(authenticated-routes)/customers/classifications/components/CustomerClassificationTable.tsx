        ...
        <div className="overflow-x-auto" style={{ backgroundColor: 'white' }}>
          <table className="w-full border-collapse min-w-full" style={{ backgroundColor: 'white' }}>
            ...
            <tbody style={{ backgroundColor: 'white' }}>
              {tableData.length > 0 ? tableData.map((customerClassification, index) => (
                <tr 
              ...
              <tr>
                <td colSpan={headers.length} className="px-6 py-8 text-center text-gray-500">
                  {searchTerm ? `No customer classifications found matching "${searchTerm}"` : 'No customer classifications found'}
                </td>
              </tr>
            )}
            </tbody>
