...
export default function TownModal({
  show,
  isCreateMode,
  selectedTown,
  activeTab,
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            {isCreateMode ? 'Create Town' : 'Edit Town'}
          </h2>
          <button
            onClick={onClose}
            style={{
        ...
        <div>
          ...
          {activeTab === 'approval' && !isCreateMode && selectedTown && (
            <div>
              <div className="mb-5">
                ...
                {selectedTown?.forApprovalVersion ? (
                  <div style={{
                    ...
                    {/* Town Name */}
                    {selectedTown.forApprovalVersion.townName !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        ...
                        <input
                          type="text"
                          value={String(selectedTown.forApprovalVersion.townName)}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {/* Status */}
                    {selectedTown.forApprovalVersion.status !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        <label style={{
                          display: 'block',
                          fontSize: '14px',
                        ...
                        <input
                          type="text"
                          value={String(selectedTown.forApprovalVersion.status)}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {Object.entries(selectedTown.forApprovalVersion).map(([key, value]) => {
                      // Skip the fields we've already handled
                      if (key === 'townName' || key === 'status') {
                        return null;
                      }
