...
export default function AreaForm({
    ...
    const canEditFields = isCreateMode || selectedArea?.status === StatusEnum.ACTIVE;
    ...
    const getStatusBadge = (status: StatusEnum) => {
        ...
        return (
            <span
                className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-bold ${badgeClasses}`}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="mt-8 flex flex-col gap-3 border-t-2 border-gray-200 pt-6 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center">
                        ...
                        {(isCreateMode || (canEditFields && selectedArea?.status !== StatusEnum.INACTIVE)) && (
                            <button
                                type="submit"
