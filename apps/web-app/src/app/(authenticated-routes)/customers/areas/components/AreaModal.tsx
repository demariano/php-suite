      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            {isCreateMode ? 'Create Area' : 'Edit Area'}
          </h2>
          <button
            onClick={onClose}
            style={{
        ...
        <div>
          ...
          {activeTab === 'approval' && !isCreateMode && selectedArea && (
            <div>
              <div className="mb-5">
                ...
                {selectedArea?.forApprovalVersion ? (
                  <div style={{
                    ...
                    {/* Area Name */}
                    {selectedArea.forApprovalVersion.areaName !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        ...
                        <input
                          type="text"
                          value={String(selectedArea.forApprovalVersion.areaName)}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {/* Status */}
                    {selectedArea.forApprovalVersion.status !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        <label style={{
                          display: 'block',
                          fontSize: '14px',
                        ...
                        <input
                          type="text"
                          value={String(selectedArea.forApprovalVersion.status)}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
