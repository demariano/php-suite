                                    ...
                                    <div className="mb-5">
                                        ...
                                        {selectedCustomer?.forApprovalVersion ? (
                                            ...
                                            >
                                                ...
                                                {selectedCustomer.forApprovalVersion.customerName !== undefined && (
                                                    <div style={{ marginBottom: '20px' }}>
                                                        ...
                                                        <input
                                                            type="text"
                                                            value={String(
                                                                selectedCustomer.forApprovalVersion.customerName
                                                            )}
                                                            readOnly
                                                            style={{
                                                                width: '100%',
                                                                padding: '12px 16px',
                                                                border: isFieldChanged('customerName')
                                                                    ? '2px solid #3b82f6'
                                                                    : '2px solid #d1d5db',
                                                                borderRadius: '8px',
                                                                fontSize: '14px',
                                                                outline: 'none',
                                                                backgroundColor: isFieldChanged('customerName')
                                                                    ? '#eff6ff'
                                                                    : '#f9fafb',
                                                                color: '#6b7280',
                                                                fontWeight: '500',
                                                ...
                                                {selectedCustomer.forApprovalVersion.email !== undefined && (
                                                    <div style={{ marginBottom: '20px' }}>
                                                        ...
                                                        <input
                                                            type="text"
                                                            value={String(
                                                                selectedCustomer.forApprovalVersion.email ?? ''
                                                            )}
                                                            readOnly
                                                            style={{
                                                                width: '100%',
                                                                padding: '12px 16px',
                                                                border: isFieldChanged('email')
                                                                    ? '2px solid #3b82f6'
                                                                    : '2px solid #d1d5db',
                                                                borderRadius: '8px',
                                                                fontSize: '14px',
                                                                outline: 'none',
                                                                backgroundColor: isFieldChanged('email')
                                                                    ? '#eff6ff'
                                                                    : '#f9fafb',
                                                                color: '#6b7280',
                                                                fontWeight: '500',
                                                        ...
                                                        return (
                                                            <div style={{ marginBottom: '20px' }}>
                                                                ...
                                                                <input
                                                                    type="text"
                                                                    value={String(
                                                                        selectedCustomer.forApprovalVersion.contactNo ??
                                                                            ''
                                                                    )}
                                                                    readOnly
                                                                    style={{
                                                                        width: '100%',
                                                                        padding: '12px 16px',
                                                                        border: contactNoChanged
                                                                            ? '2px solid #3b82f6'
                                                                            : '2px solid #d1d5db',
                                                                        borderRadius: '8px',
                                                                        fontSize: '14px',
                                                                        outline: 'none',
                                                                        backgroundColor: contactNoChanged
                                                                            ? '#eff6ff'
                                                                            : '#f9fafb',
                                                                        color: '#6b7280',
                                                                        fontWeight: '500',
                                                ...
                                                {selectedCustomer.forApprovalVersion.contactPerson !== undefined && (
                                                    <div style={{ marginBottom: '20px' }}>
                                                        ...
                                                        <input
                                                            type="text"
                                                            value={String(
                                                                selectedCustomer.forApprovalVersion.contactPerson ?? ''
                                                            )}
                                                            readOnly
                                                            style={{
                                                                width: '100%',
                                                                padding: '12px 16px',
                                                                border: isFieldChanged('contactPerson')
                                                                    ? '2px solid #3b82f6'
                                                                    : '2px solid #d1d5db',
                                                                borderRadius: '8px',
                                                                fontSize: '14px',
                                                                outline: 'none',
                                                                backgroundColor: isFieldChanged('contactPerson')
                                                                    ? '#eff6ff'
                                                                    : '#f9fafb',
                                                                color: '#6b7280',
                                                                fontWeight: '500',
                                                        ...
                                                        return (
                                                            <div style={{ marginBottom: '20px' }}>
                                                                ...
                                                                <input
                                                                    type="text"
                                                                    value={String(
                                                                        selectedCustomer.forApprovalVersion.tinNumber ??
                                                                            ''
                                                                    )}
                                                                    readOnly
                                                                    style={{
                                                                        width: '100%',
                                                                        padding: '12px 16px',
                                                                        border: tinNumberChanged
                                                                            ? '2px solid #3b82f6'
                                                                            : '2px solid #d1d5db',
                                                                        borderRadius: '8px',
                                                                        fontSize: '14px',
                                                                        outline: 'none',
                                                                        backgroundColor: tinNumberChanged
                                                                            ? '#eff6ff'
                                                                            : '#f9fafb',
                                                                        color: '#6b7280',
                                                                        fontWeight: '500',
                                                ...
                                                {/* Customer Terms */}
                                                {selectedCustomer.forApprovalVersion.customerTerms &&
                                                    selectedCustomer.forApprovalVersion.customerTerms.length > 0 && (
                                                        <div
                                                            style={{
                                                                marginBottom: '20px',
                                                        ...
                                                        >
                                                            <h4
                                                                style={{
                                                                    ...
                                                                    color: '#1f2937',
                                                                    marginBottom: '16px',
                                                                    padding: hasArrayChanges('customerTerms')
                                                                        ? '8px 12px'
                                                                        : '0',
                                                                    backgroundColor: hasArrayChanges('customerTerms')
                                                                        ? '#eff6ff'
                                                                        : 'transparent',
                                                                    borderRadius: hasArrayChanges('customerTerms')
                                                                        ? '6px'
                                                                        : '0',
                                                                    border: hasArrayChanges('customerTerms')
                                                                        ? '2px solid #3b82f6'
                                                                        : 'none',
                                                            ...
                                                            >
                                                                {selectedCustomer.forApprovalVersion.customerTerms.map(
                                                ...
                                                {/* Product Deals */}
                                                {selectedCustomer.forApprovalVersion.customerProductDeals &&
                                                    selectedCustomer.forApprovalVersion.customerProductDeals.length >
                                                        0 && (
                                                        <div
                                                            style={{
                                                                marginBottom: '20px',
                                                        ...
                                                        >
                                                            <h4
                                                                style={{
                                                                    ...
                                                                    color: '#1f2937',
                                                                    marginBottom: '16px',
                                                                    padding: hasArrayChanges('customerProductDeals')
                                                                        ? '8px 12px'
                                                                        : '0',
                                                                    backgroundColor: hasArrayChanges(
                                                                        'customerProductDeals'
                                                                    )
                                                                        ? '#eff6ff'
                                                                        : 'transparent',
                                                                    borderRadius: hasArrayChanges(
                                                                        'customerProductDeals'
                                                                    )
                                                                        ? '6px'
                                                                        : '0',
                                                                    border: hasArrayChanges('customerProductDeals')
                                                                        ? '2px solid #3b82f6'
                                                                        : 'none',
                                                                    display: 'inline-block',
                                                                }}
                                                            ...
                                                            >
                                                                {selectedCustomer.forApprovalVersion.customerProductDeals.map(
                                                                    (productDeal: any, index: number) => (
                                                                        <div
                                                                            key={index}
                                                                            style={{
                                                                                border: '2px solid #e2e8f0',
                                                ...
                                                {Object.entries(selectedCustomer.forApprovalVersion).map(
                                                    ([key, value]) => {
