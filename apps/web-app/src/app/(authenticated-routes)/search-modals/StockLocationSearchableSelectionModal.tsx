...
export default function StockLocationSearchableSelectionModal({
  ...
  const loadItems = async (searchQuery?: string) => {
    ...
    try {
      ...
      if (searchQuery) {
        response = await StockLocationApi.searchStockLocationsByName(
          searchQuery,
          limit,
          direction,
          cursor
        ...
        response = await StockLocationApi.getStockLocationsByStatus(
          limit,
          'ACTIVE',
          direction,
          cursor
        ...
        <div style={{
          ...
          {loading ? (
            ...
            <div style={{
              ...
              {searchTerm ? `No stock locations found matching "${searchTerm}"` : 'No stock locations available'}
            </div>
          ) : (
            <div>
