...
interface ProductUnitSearchableSelectionModalProps {
  show: boolean;
  title: string;
...
export default function ProductUnitSearchableSelectionModal({
  show,
  title,
  selectedValue,
  onSelect,
  ...
  const handleSelect = (item: Item) => {
    // Create a full ProductUnitDto object
    const productUnit: ProductUnitDto = {
            ...
            <div className="bg-white rounded-2xl w-[520px] max-w-[90vw] max-h-[80vh] overflow-hidden shadow-2xl flex flex-col border border-gray-100">
                ...
                <div className="px-6 pb-4">
                    <div className="relative">
                        ...
                        <input
                            ...
                            placeholder="Search product units by name..."
                    ...
                    {loading ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-12 text-gray-400">
                            ...
                            <span className="text-sm font-medium">
                                {searchTerm ? `No product units matching "${searchTerm}"` : 'No product units available'}
                            </span>
                            {searchTerm && (
                ...
                <div className="border-t border-gray-100 px-6 py-3 flex items-center justify-between">
                    <span className="text-xs text-gray-400">
                        {items.length > 0 ? `${items.length} ${items.length !== 1 ? 'product units' : 'product unit'} shown` : ''}
                    </span>
