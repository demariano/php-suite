...
interface ProductCategorySearchableSelectionModalProps {
  show: boolean;
  title: string;
...
export default function ProductCategorySearchableSelectionModal({
  show,
  title,
  selectedValue,
  onSelect,
  onClose
}: ProductCategorySearchableSelectionModalProps) {
  ...
  const handleSelect = (item: Item) => {
    // Create a full ProductCategoryDto object
            ...
            <div className="bg-white rounded-2xl w-[520px] max-w-[90vw] max-h-[80vh] overflow-hidden shadow-2xl flex flex-col border border-gray-100">
                    ...
                    {loading ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-12 text-gray-400">
                            ...
                            <span className="text-sm font-medium">
                                {searchTerm ? `No product categories matching "${searchTerm}"` : 'No product categories available'}
                            </span>
                            {searchTerm && (
                ...
                <div className="border-t border-gray-100 px-6 py-3 flex items-center justify-between">
                    <span className="text-xs text-gray-400">
                        {items.length > 0 ? `${items.length} ${items.length !== 1 ? 'product categories' : 'product category'} shown` : ''}
                    </span>
