...
interface StockTypeSearchableSelectionModalProps {
  show: boolean;
  title: string;
  selectedValue: string | null;
  onSelect: (stockType: StockTypeDto) => void;
  onClose: () => void;
}
...
export default function StockTypeSearchableSelectionModal({
  show,
  title,
  selectedValue,
  onSelect,
  onClose
}: StockTypeSearchableSelectionModalProps) {
  ...
  const handleSelect = (item: Item) => {
    // Create a full StockTypeDto object
    const stockType: StockTypeDto = {
      stockTypeId: item.id,
            ...
            <div className="bg-white rounded-2xl w-[520px] max-w-[90vw] max-h-[80vh] overflow-hidden shadow-2xl flex flex-col border border-gray-100">
                ...
                <div className="px-6 pb-4">
                    <div className="relative">
                        ...
                        <input
                            ...
                            placeholder="Search stock types by name..."
                    ...
                    {loading ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-12 text-gray-400">
                            ...
                            <span className="text-sm font-medium">
                                {searchTerm ? `No stock types matching "${searchTerm}"` : 'No stock types available'}
                            </span>
                            {searchTerm && (
                ...
                <div className="border-t border-gray-100 px-6 py-3 flex items-center justify-between">
                    <span className="text-xs text-gray-400">
                        {items.length > 0 ? `${items.length} ${items.length !== 1 ? 'stock types' : 'stock type'} shown` : ''}
                    </span>
