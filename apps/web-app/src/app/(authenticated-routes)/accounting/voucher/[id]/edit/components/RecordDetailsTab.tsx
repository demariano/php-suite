...
export default function RecordDetailsTab({
    ...
    const getStatusBadge = (status: StatusEnum) => {
        const colorClasses = STATUS_BADGE_CLASSES[status] ?? STATUS_BADGE_CLASSES[StatusEnum.INACTIVE];
        return (
            <span
                            ...
                            <SelectionField
                                ...
                                selectedItem={
                                    formData.accountName
                                        ? { id: formData.accountId || '', name: formData.accountName }
                                        : null
                                }
                                ...
                                disabled={!isCreateMode || isReadOnly}
                                isHighlighted={
                                    isFieldChanged && (isFieldChanged('accountId') || isFieldChanged('accountName'))
                                }
                            />
                        </div>
                        ...
                        {formData.accountType === AccountTypeEnum.CUSTOMER && (
                            <div className="group">
                                <SelectionField
                                    ...
                                    isHighlighted={
                                        isFieldChanged &&
                                        (isFieldChanged('customerId') || isFieldChanged('customerName'))
                                    }
                                />
                            </div>
                        )}
                        ...
                        {formData.accountType === AccountTypeEnum.AREA && (
                            <div className="group">
                                <SelectionField
                                    ...
                                    selectedItem={
                                        formData.areaName
                                            ? { id: formData.areaId || '', name: formData.areaName }
                                            : null
                                    }
                                    ...
                                    disabled={!isCreateMode || isReadOnly}
                                    isHighlighted={
                                        isFieldChanged && (isFieldChanged('areaId') || isFieldChanged('areaName'))
                                    }
                                />
                            </div>
                        )}
            ...
            <div className="space-y-4">
                <div className="border-2 border-gray-200 rounded-xl p-4 sm:p-6">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-base font-bold text-blue-600">Payment Information</h3>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {/* Payment Type */}
                        <div className="group">
