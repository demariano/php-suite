    ...
    return (
        <div className="flex justify-center">
            <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-xl w-full sm:max-w-6xl">
                            ...
                            const hasArrayChanges = (fieldName: string): boolean => {
                                ...
                                const normalizeArray = (arr: any[], idField: string) => {
                                    return arr
                                        ...
                                        .sort((a, b) =>
                                            (a[idField] || '').toString().localeCompare((b[idField] || '').toString())
                                        );
                                };
                ...
                {/* Action Buttons */}
                {activeTab !== 'approval' && (
                    <div className="flex flex-col gap-3 border-t-2 border-gray-200 px-4 sm:px-6 py-6 sm:flex-row sm:items-center sm:justify-between">
