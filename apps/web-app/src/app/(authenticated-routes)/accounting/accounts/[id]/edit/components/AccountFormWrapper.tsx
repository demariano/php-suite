...
export default function AccountFormWrapper({
      ...
      <div className="space-y-2">
        ...
        <div
          className={`w-full rounded-xl border-2 px-4 py-3 text-sm font-medium shadow-sm ${
            changed ? 'border-blue-500 bg-blue-50 text-gray-800' : 'border-gray-200 bg-gray-50 text-gray-600'
          }`}
        >
        ...
        <div className="rounded-xl border-2 border-gray-200 bg-white p-4 shadow-sm sm:p-6">
          <div className="mb-4 flex items-center gap-3">
            ...
            <h3
              className={`text-base font-bold ${
                changed ? 'rounded-lg border-2 border-blue-500 bg-blue-50 px-3 py-1 text-blue-700' : 'text-blue-600'
              }`}
            >
              Sub Accounts
            </h3>
          ...
          {allRemoved ? (
            <div className="rounded-xl border-2 border-amber-300 bg-amber-50 p-4 shadow-sm">
              <p className="text-sm font-semibold text-amber-800">All sub accounts will be removed once approved.</p>
      ...
      {isAdminUser ? (
        <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row">
          ...
          >
            ...
            {status === StatusEnum.FOR_DELETION ? 'Deny Deletion' : 'Deny Changes'}
          </button>
          <button
            type="button"
            onClick={onApprove}
          ...
          >
            ...
            {status === StatusEnum.FOR_DELETION ? 'Approve Deletion' : 'Approve Changes'}
          </button>
        </div>
      ) : (
          ...
          <div className="rounded-xl border-2 border-red-300 bg-red-50 p-6 shadow-sm sm:p-8">
            <div className="mb-4 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="m-0 text-sm text-red-700">This record has been flagged and is awaiting approval.</p>
              </div>
            </div>
            {selectedAccount.changeReason && (
              <div className="rounded-xl border-2 border-red-200 bg-white p-4">
                ...
                <p className="m-0 whitespace-pre-wrap text-sm leading-relaxed text-gray-700">{selectedAccount.changeReason}</p>
              </div>
            )}
          </div>
          ...
          {selectedAccount.changeReason && (
            <div className="mb-6 rounded-xl border-2 border-gray-200 bg-white p-5 shadow-sm">
              <div className="mb-3 flex items-center gap-3">
                ...
                <h4 className="m-0 text-base font-bold text-blue-600">Change Reason</h4>
              </div>
              <p className="m-0 whitespace-pre-wrap font-mono text-sm font-medium leading-relaxed text-gray-700">
                {selectedAccount.changeReason}
              </p>
            </div>
          )}
  ...
  const tabs = [
    ...
    },
    {
      ...
      label: status === StatusEnum.FOR_DELETION ? 'Deletion Request' : 'Pending Changes',
