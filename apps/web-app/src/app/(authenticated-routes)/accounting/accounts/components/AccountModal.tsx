            ...
            >
                ...
                <div>
                        ...
                        >
                            ...
                            >
                                ...
                                <span style={{ color: '#dc2626', fontWeight: '600', fontSize: '14px' }}>
                                    Change reason is required when making modifications to the account record. Please
                                    fill out the Change Reason field below.
                                </span>
                            </div>
                        </div>
                    )}
                    ...
                    {activeTab === 'approval' && !isCreateMode && selectedAccount && (
                        <div>
                            <div className="mb-5">
                                {(selectedAccount.status === StatusEnum.FOR_APPROVAL ||
                                    selectedAccount.status === StatusEnum.NEW_RECORD) && (
                                    ...
                                    >
                                        ...
                                        {selectedAccount.forApprovalVersion.subAccounts !== undefined && (
                                            <div style={{ marginBottom: '20px' }}>
                                                ...
                                                {Array.isArray(selectedAccount.forApprovalVersion.subAccounts) &&
                                                selectedAccount.forApprovalVersion.subAccounts.length > 0 ? (
                                                    <div
                                                        style={{
                                                            backgroundColor: 'white',
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <tbody>
                                                                {selectedAccount.forApprovalVersion.subAccounts.map(
                                                                    (subAccount: string, index: number) => (
                                                                        <tr
                                                                            key={index}
                                                                            style={{
                                                                                borderBottom:
                                    ...
                                    <div className="bg-gray-50 p-4 rounded-md border border-gray-200 max-h-72 overflow-y-auto">
                                        {selectedAccount.activityLogs.map((log, index) => (
                                            <div
                                                key={index}
                                                className={`py-2 ${
                                                    index < selectedAccount.activityLogs!.length - 1
