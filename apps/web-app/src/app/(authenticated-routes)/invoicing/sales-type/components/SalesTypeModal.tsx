                                        ...
                                        {selectedSalesType.forApprovalVersion.allowDiscount !== undefined && (
                                            <div style={{ marginBottom: '20px' }}>
                                                ...
                                                <input
                                                    type="text"
                                                    value={
                                                        selectedSalesType.forApprovalVersion.allowDiscount
                                                            ? 'Yes'
                                                            : 'No'
                                                    }
                                                    readOnly
                                        ...
                                        {selectedSalesType.forApprovalVersion.contractSales !== undefined && (
                                            <div style={{ marginBottom: '20px' }}>
                                                ...
                                                <input
                                                    type="text"
                                                    value={
                                                        selectedSalesType.forApprovalVersion.contractSales
                                                            ? 'Yes'
                                                            : 'No'
                                                    }
                                                    readOnly
                                        ...
                                        {selectedSalesType.forApprovalVersion.incomeGenerating !== undefined && (
                                            <div style={{ marginBottom: '20px' }}>
                                                ...
                                                <input
                                                    type="text"
                                                    value={
                                                        selectedSalesType.forApprovalVersion.incomeGenerating
                                                            ? 'Yes'
                                                            : 'No'
                                                    }
                                                    readOnly
                                    ...
                                    <div className="bg-gray-50 p-4 rounded-md border border-gray-200 max-h-72 overflow-y-auto">
                                        {selectedSalesType.activityLogs.map((log, index) => (
                                            <div
                                                key={index}
                                                className={`py-2 ${
                                                    index < selectedSalesType.activityLogs!.length - 1
