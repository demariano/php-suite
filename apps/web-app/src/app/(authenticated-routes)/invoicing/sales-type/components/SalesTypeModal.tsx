      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            {isCreateMode ? 'Create Sales Type' : 'Edit Sales Type'}
          </h2>
          <button
            onClick={onClose}
            style={{
        ...
        <div>
          ...
          {activeTab === 'approval' && !isCreateMode && selectedSalesType && (
            <div>
              <div className="mb-5">
                {(selectedSalesType.status === StatusEnum.FOR_APPROVAL || selectedSalesType.status === StatusEnum.NEW_RECORD) && (
                ...
                {selectedSalesType?.forApprovalVersion ? (
                  <div style={{
                    ...
                    {/* Sales Type Name */}
                    {selectedSalesType.forApprovalVersion.salesTypeName !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        ...
                        <input
                          type="text"
                          value={String(selectedSalesType.forApprovalVersion.salesTypeName)}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {/* Allow Discount */}
                    {selectedSalesType.forApprovalVersion.allowDiscount !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        <label style={{
                          display: 'block',
                          fontSize: '14px',
                        ...
                        <input
                          type="text"
                          value={selectedSalesType.forApprovalVersion.allowDiscount ? 'Yes' : 'No'}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {/* Contract Sales */}
                    {selectedSalesType.forApprovalVersion.contractSales !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        <label style={{
                          display: 'block',
                          fontSize: '14px',
                        ...
                        <input
                          type="text"
                          value={selectedSalesType.forApprovalVersion.contractSales ? 'Yes' : 'No'}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {/* Income Generating */}
                    {selectedSalesType.forApprovalVersion.incomeGenerating !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        <label style={{
                          display: 'block',
                          fontSize: '14px',
                        ...
                        <input
                          type="text"
                          value={selectedSalesType.forApprovalVersion.incomeGenerating ? 'Yes' : 'No'}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {/* Taxable */}
                    {selectedSalesType.forApprovalVersion.taxable !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        <label style={{
                          display: 'block',
                          fontSize: '14px',
                        ...
                        <input
                          type="text"
                          value={selectedSalesType.forApprovalVersion.taxable ? 'Yes' : 'No'}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {/* Default Discount */}
                    {selectedSalesType.forApprovalVersion.defaultDiscount !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        <label style={{
                          display: 'block',
                          fontSize: '14px',
                        ...
                        <input
                          type="text"
                          value={`${selectedSalesType.forApprovalVersion.defaultDiscount}%`}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {/* Default Tax */}
                    {selectedSalesType.forApprovalVersion.defaultTax !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        <label style={{
                          display: 'block',
                          fontSize: '14px',
                        ...
                        <input
                          type="text"
                          value={`${selectedSalesType.forApprovalVersion.defaultTax}%`}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {/* Status */}
                    {selectedSalesType.forApprovalVersion.status !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        <label style={{
                          display: 'block',
                          fontSize: '14px',
                        ...
                        <input
                          type="text"
                          value={String(selectedSalesType.forApprovalVersion.status)}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
