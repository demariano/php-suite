...
export default function EditSalesTypePage({ params }: EditSalesTypePageProps) {
    ...
    const handleSave = async (salesType: SalesTypeDto) => {
        ...
        try {
            ...
            const updatedRecord = await SalesTypeApi.updateSalesType(
                    ...
                    <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center">
                        {isAdminUser &&
                            ...
                            [StatusEnum.FOR_APPROVAL, StatusEnum.NEW_RECORD, StatusEnum.FOR_DELETION].includes(
                                selectedSalesType.status as StatusEnum
                            ) && (
                                <>
                                    <button
                                        type="button"
                                    ...
                                    <span className="flex items-center gap-2">
                                        ...
                                        {selectedSalesType && (
                                            <>
                                                ...
                                                <span>
                                                    {getStatusText(selectedSalesType.status || StatusEnum.ACTIVE)}
                                                </span>
                                            </>
                                        )}
                                    </span>
