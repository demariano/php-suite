              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-600">{contract.contractName || 'No name'}</p>
                  </div>
                ...
                <dl className="mt-4 grid grid-cols-1 gap-3 text-sm text-gray-700">
                  <div className="flex justify-between gap-3">
                    ...
                    <dd className="text-right text-gray-900">{contract.customerName || '-'}</dd>
                  </div>
                  <div className="flex justify-between gap-3">
                    <dt className="font-medium text-gray-500">Start Date</dt>
                    <dd className="text-right text-gray-900">{contract.startDate ? new Date(contract.startDate).toLocaleDateString() : '-'}</dd>
                  </div>
                  <div className="flex justify-between gap-3">
