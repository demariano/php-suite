...
export default function ContractForm({
    ...
    useEffect(() => {
        if (!isCreateMode && selectedContract && !userHasMadeSelections) {
            ...
            if (contractData.contractProductDeals) {
                setContractProductDeals(
                    contractData.contractProductDeals.map((deal) => ({
            ...
            setFormData({
                ...
                totalAmountPaid: contractData.totalAmountPaid?.toString() || '0',
        ...
        if (isCreateMode) {
            const newContract = {
                ...
                contractType: formData.contractType
                    ? (formData.contractType as ContractTypeEnum)
                    : ContractTypeEnum.REGULAR,
                ...
                totalAmountPaid: parseFloat(formData.totalAmountPaid) || 0,
                ...
                rebateClaimedAmount: formData.rebateClaimedAmount
                    ? parseFloat(formData.rebateClaimedAmount)
                    : undefined,
                rebateClaimedStatus: formData.rebateClaimedStatus
                    ? (formData.rebateClaimedStatus as RebateClaimedStatusEnum)
                    : undefined,
    ...
    const handleDealsSelect = (product: {
        ...
        const existingDeal = contractProductDeals.find(
            (contractDeal) =>
                        ...
                        <div className="border-2 border-gray-200 rounded-xl p-4 sm:p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="group">
                                    ...
                                    <input
                                        type="text"
                                        value={formatNumberWithCommas(formData.totalAmountPaid)}
                                        readOnly
                                        className="w-full rounded-xl border-2 border-gray-200 bg-gray-50 px-4 py-3 text-sm font-medium text-gray-500 shadow-sm cursor-not-allowed"
                                    />
                                </div>
