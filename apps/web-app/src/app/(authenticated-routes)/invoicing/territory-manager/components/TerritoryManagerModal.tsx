        ...
        const fetchAreas = async () => {
            if (activeTab === 'areas' && selectedTerritoryManager?.territoryManagerId) {
                try {
                    ...
                    console.log('Areas data length:', areasData ? (areasData as any).length : 'undefined');
                    ...
                    {activeTab === 'approval' &&
                        ...
                        (() => {
                            ...
                            const isFieldChanged = createFieldChangeDetector(
                                selectedTerritoryManager as any,
                                selectedTerritoryManager.forApprovalVersion as any
                            );
                                        ...
                                        <div className="space-y-4">
                                            <div className="border-2 border-gray-200 rounded-xl p-4 sm:p-6">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                    {approvalData.territoryManagerName !== undefined &&
                                                        renderReadOnlyField(
                                                            'Territory Manager Name',
                                                            approvalData.territoryManagerName,
                                                            'territoryManagerName'
                                                        )}
                                                    {approvalData.contactNo !== undefined &&
                                                        renderReadOnlyField(
                                                            'Contact Number',
                                                            approvalData.contactNo,
                                                            'contactNo'
                                                        )}
                                                </div>
                                            </div>
                        ...
                        <div>
                            <div className="mb-5">
                                ...
                                {renderActivityLogsTable(
                                    selectedTerritoryManager?.activityLogs,
