      ...
      <div className="w-full max-w-md sm:max-w-lg rounded-xl bg-white p-6 shadow-lg">
        <div className="mb-4 flex items-center gap-3">
          ...
          <h3 className="m-0 text-lg font-semibold text-gray-800">
            Delete Collection Receipt Range
          </h3>
        </div>

        <p className="mb-6 text-sm leading-relaxed text-gray-600">
          Are you sure you want to delete the range for <strong>&quot;{range.areaName}&quot;</strong> 
          ({range.startNumber} - {range.endNumber})? This action cannot be undone.
        </p>
