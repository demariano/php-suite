                        ...
                        {!isCreateMode && selectedPayment?.status !== StatusEnum.ACTIVE && (
                            <div className="bg-yellow-50 border-2 border-yellow-300 rounded-xl p-4 shadow-sm">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <h4 className="text-sm font-semibold text-yellow-800 m-0">Read-Only Mode</h4>
                                </div>
                                <p className="text-sm text-yellow-700 m-0 leading-relaxed">
                                    This payment is pending approval. You can view the original details here, but cannot
                                    make changes. Use the &quot;Pending Changes&quot; tab to see the proposed changes.
                                </p>
                            </div>
                        )}
                            ...
                            <div className="bg-red-50 border-2 border-red-300 rounded-xl p-4 shadow-sm">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-red-700 m-0 leading-relaxed">{receiptNumberError}</p>
                                        <p className="text-xs text-red-600 mt-2 m-0">
                                            Please contact an administrator to set up receipt number ranges for this
                                            customer&apos;s area.
                                        </p>
                                    </div>
                                </div>
