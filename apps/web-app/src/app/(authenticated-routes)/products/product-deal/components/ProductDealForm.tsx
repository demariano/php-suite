...
export default function ProductDealForm({
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      {!isCreateMode && selectedProductDeal &&
        (selectedProductDeal.status === StatusEnum.FOR_APPROVAL ||
          selectedProductDeal.status === StatusEnum.NEW_RECORD ||
          selectedProductDeal.status === StatusEnum.FOR_DELETION) && (
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <div className="group">
                ...
                <input
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, productDealName: e.target.value }))}
              ...
              <div className="group sm:col-span-2">
                ...
                <input
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, additionalQty: e.target.value }))}
      ...
      <div className="mt-8 flex flex-col gap-3 border-t-2 border-gray-200 pt-6 sm:flex-row sm:items-center sm:justify-between">
        {!isCreateMode && selectedProductDeal?.status === StatusEnum.ACTIVE ? (
          <button
            type="button"
            onClick={(e) => {
              e.preventDefault();
        ...
        ) : isAdminUser && !isCreateMode && selectedProductDeal && 
          ...
          <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row">
            ...
            >
              ...
              {selectedProductDeal.status === StatusEnum.FOR_DELETION ? 'Deny Deletion' : 'Deny Changes'}
            </button>
            <button
              type="button"
              onClick={onApprove}
            ...
            >
              ...
              {selectedProductDeal.status === StatusEnum.FOR_DELETION ? 'Approve Deletion' : 'Approve Changes'}
            </button>
          </div>
        ) : (
