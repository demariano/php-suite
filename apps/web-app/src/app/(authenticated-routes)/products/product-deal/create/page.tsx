...
import { ProductDealApi, ProductDealDto, extractErrorMessage, useEnv, useLocalStore, useSessionStore } from '@data-access/index';
import { useRouter } from 'next/navigation';
import { useState } from 'react';
import ProductDealForm from '../components/ProductDealForm';

export default function CreateProductDealPage() {
  ...
  const handleSave = async (productDeal: ProductDealDto) => {
    try {
      ...
      await ProductDealApi.createProductDeal({
      ...
      const errorMessage = extractErrorMessage(error, 'Failed to create product deal. Please try again.');
      setFlashNotification({
        title: 'Error',
