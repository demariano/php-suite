...
interface CategoryHeaderProps {
    ...
    onStatusFilterChange: (status: StatusEnum | 'ALL') => void;
    onRefresh: () => void;
    onCreateClick: () => void;
    isLoading?: boolean;
    canCreate?: boolean;
                ...
                <div className="flex w-full items-center gap-3 sm:flex-1">
                    ...
                    <div className="flex-shrink-0 w-48">
                        <select
                            ...
                            className="w-full rounded-xl border-2 border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow-sm transition-all duration-200 hover:border-gray-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        >
