    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <div className="mt-8 flex flex-col gap-3 border-t-2 border-gray-200 pt-6 sm:flex-row sm:items-center sm:justify-between">
                {!isCreateMode && selectedCategory?.status === StatusEnum.ACTIVE && isAdminUser ? (
                    <button
                        type="button"
                        onClick={(e) => {
                            e.preventDefault();
                ...
                ) : !isCreateMode && selectedCategory?.status === StatusEnum.INACTIVE && isAdminUser && onReactivate ? (
                    <button
                        type="button"
                        onClick={(e) => {
                            e.preventDefault();
                ...
                <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center">
                    {(isCreateMode ||
                        ...
                        (selectedCategory && !isAdminUser && selectedCategory.status === StatusEnum.FOR_APPROVAL)) && (
                        <button
                            type="submit"
