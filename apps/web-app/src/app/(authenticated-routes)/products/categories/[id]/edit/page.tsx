...
export default function EditCategoryPage({ params }: EditCategoryPageProps) {
    ...
    const handleApprove = async () => {
        ...
        try {
            ...
            const approvedCategory = await ProductApi.approveProductCategory(
    ...
    const handleDenyConfirm = async (approverMessage: string) => {
        ...
        try {
            ...
            const deniedCategory = await ProductApi.denyProductCategory(
                selectedCategory.productCategoryId,
                approverMessage,
                userRole
            );
            ...
            <div className="space-y-6 animate-fadeIn rounded-xl border-2 border-green-400 bg-white p-4 shadow-sm sm:p-6">
                ...
                <div className="space-y-4">
                    <div className="border-2 border-gray-200 rounded-xl p-4 sm:p-6">
                        ...
                        <div className="grid grid-cols-1 gap-6">
                            {renderReadOnlyField(
                                'Category Name',
                                approvalData.productCategoryName,
                                'bg-blue-500',
                                'productCategoryName'
                            )}
                        </div>
                ...
                <div className="mt-8 flex flex-col gap-3 border-t-2 border-gray-200 pt-6 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    [StatusEnum.FOR_APPROVAL, StatusEnum.NEW_RECORD, StatusEnum.FOR_DELETION].includes(
                        selectedCategory.status as StatusEnum
                    ) ? (
                        <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row">
                            <button
                                type="button"
                                    ...
                                    <span className="flex items-center gap-2">
                                        ...
                                        {selectedCategory && (
                                            <>
                                                ...
                                                <span>
                                                    {getStatusText(selectedCategory.status || StatusEnum.ACTIVE)}
                                                </span>
                                            </>
                                        )}
                                    </span>
