...
export default function ProductPriceTypeForm({
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      {!isCreateMode && selectedProductPriceType &&
        (selectedProductPriceType.status === StatusEnum.FOR_APPROVAL ||
          selectedProductPriceType.status === StatusEnum.NEW_RECORD ||
          selectedProductPriceType.status === StatusEnum.FOR_DELETION) && (
          ...
          <div className="rounded-xl border-2 border-gray-200 p-4 sm:p-6">
            ...
            <div className="group">
              ...
              <input
                ...
                onChange={(e) => setFormData(prev => ({ ...prev, productPriceTypeName: e.target.value }))}
      ...
      <div className="mt-8 flex flex-col gap-3 border-t-2 border-gray-200 pt-6 sm:flex-row sm:items-center sm:justify-between">
        {!isCreateMode && selectedProductPriceType?.status === StatusEnum.ACTIVE ? (
          <button
            type="button"
            onClick={(e) => {
              e.preventDefault();
