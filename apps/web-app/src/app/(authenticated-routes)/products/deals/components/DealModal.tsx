    ...
    <div style={{
      ...
      <div style={{
        ...
        <div>
          ...
          {activeTab === 'approval' && !isCreateMode && selectedDeal && (
            <div>
              <div className="mb-5">
                {(selectedDeal.status === StatusEnum.FOR_APPROVAL || selectedDeal.status === StatusEnum.NEW_RECORD) && (
                ...
                {selectedDeal?.forApprovalVersion ? (
                  <div style={{
                    ...
                    {/* Product Deal Name */}
                    {selectedDeal.forApprovalVersion.productDealName !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        ...
                        <input
                          type="text"
                          value={String(selectedDeal.forApprovalVersion.productDealName)}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {/* Min Quantity */}
                    {selectedDeal.forApprovalVersion.minQty !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        <label style={{
                          display: 'block',
                          fontSize: '14px',
                        ...
                        <input
                          type="text"
                          value={String(selectedDeal.forApprovalVersion.minQty)}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {/* Additional Quantity */}
                    {selectedDeal.forApprovalVersion.additionalQty !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        <label style={{
                          display: 'block',
                          fontSize: '14px',
                        ...
                        <input
                          type="text"
                          value={String(selectedDeal.forApprovalVersion.additionalQty)}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {/* Status */}
                    {selectedDeal.forApprovalVersion.status !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        <label style={{
                          display: 'block',
                          fontSize: '14px',
                        ...
                        <input
                          type="text"
                          value={String(selectedDeal.forApprovalVersion.status)}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {Object.entries(selectedDeal.forApprovalVersion).map(([key, value]) => {
                      // Skip the fields we've already handled
                      if (key === 'productDealName' || key === 'status' || key === 'minQty' || key === 'additionalQty') {
                        return null;
                      }
                  ...
                  <div className="bg-gray-50 p-4 rounded-md border border-gray-200 max-h-72 overflow-y-auto">
                    {selectedDeal.activityLogs.map((log, index) => (
                      <div 
                        key={index} 
                        className={`py-2 ${
                          index < (selectedDeal.activityLogs?.length || 0) - 1 ? 'border-b border-gray-200' : ''
                        }`}
                      >
                        {log}
                      </div>
