...
interface DeleteConfirmationModalProps {
    show: boolean;
    record: ProductUnitRawMaterialDto | null;
    onConfirm: () => void;
    onCancel: () => void;
}

export default function DeleteConfirmationModal({ show, record, onConfirm, onCancel }: DeleteConfirmationModalProps) {
    useEffect(() => {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[1000] p-4">
            <div className="bg-white rounded-xl p-6 w-full max-w-md shadow-lg space-y-6">
                <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-lg font-semibold text-gray-800 m-0">Delete Record</h3>
                </div>

                <p className="text-sm text-gray-600 leading-relaxed">
                    Are you sure you want to delete product unit raw material for <strong>{record.productName}</strong>? This action cannot be undone.
                </p>
