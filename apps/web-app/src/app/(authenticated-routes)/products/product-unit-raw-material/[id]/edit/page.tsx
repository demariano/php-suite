...
export default function EditProductUnitRawMaterialPage({ params }: EditProductUnitRawMaterialPageProps) {
    ...
    const handleSave = async (record: ProductUnitRawMaterialDto) => {
        try {
            ...
            const updatedRecord = await ProductApi.updateProductUnitRawMaterial(
                record.productUnitRawMaterialId,
                {
    ...
    const handleDeleteConfirm = async () => {
        ...
        try {
            ...
            // Navigate back to list immediately - notification will persist
            router.push('/products/product-unit-raw-material');
        } catch (error) {
    ...
    const handleDenyConfirm = async (approverMessage: string) => {
        ...
        try {
            ...
            await ProductApi.denyProductUnitRawMaterial(
                selectedRecord.productUnitRawMaterialId,
                approverMessage,
                userRole
            );
