...
interface ProductClassFormProps {
  ...
  selectedProductClass: ProductClassDto | null;
...
export default function ProductClassForm({
  ...
  useEffect(() => {
    if (!isCreateMode && selectedProductClass) {
      setFormData({
        productClassName: selectedProductClass.productClassName || '',
        changeReason: selectedProductClass.changeReason || ''
      });
    }
  ...
  const isFormDisabled = !isCreateMode && selectedProductClass?.status !== StatusEnum.ACTIVE;
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      {!isCreateMode && selectedProductClass &&
        (selectedProductClass.status === StatusEnum.FOR_APPROVAL ||
          selectedProductClass.status === StatusEnum.NEW_RECORD ||
          selectedProductClass.status === StatusEnum.FOR_DELETION) && (
            ...
            <div className="rounded-xl border-2 border-gray-200 p-4 sm:p-6">
              ...
              <div className="group">
                ...
                <div className="mt-2 text-xs text-gray-500">
                  This field is required when making changes to the product class record.
                </div>
              </div>
            </div>
          </div>
