...
interface RawMaterialsStockHeaderProps {
  searchTerm: string;
...
export default function RawMaterialsStockHeader({
  searchTerm,
  onSearchChange,
  onRefresh,
  onCreateClick,
