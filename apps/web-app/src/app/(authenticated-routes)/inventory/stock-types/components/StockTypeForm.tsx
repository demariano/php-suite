...
export default function StockTypeForm({
  ...
  useEffect(() => {
    if (!isCreateMode && selectedStockType) {
      setFormData({
        stockTypeName: selectedStockType.stockTypeName || '',
        changeReason: selectedStockType.changeReason || ''
      });
    }
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      {!isCreateMode && selectedStockType &&
        (selectedStockType.status === StatusEnum.FOR_APPROVAL ||
          selectedStockType.status === StatusEnum.NEW_RECORD ||
            ...
            <div className="rounded-xl border-2 border-gray-200 p-4 sm:p-6">
              ...
              <div className="group">
                ...
                <div className="mt-2 text-xs text-gray-500">
                  This field is required when making changes to the stock type record.
                </div>
              </div>
            </div>
          </div>
