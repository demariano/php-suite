...
import { StockTypeDto, StatusEnum } from '@data-access/index';
import { useEffect } from 'react';
import StockTypeForm from './StockTypeForm';

interface StockTypeModalProps {
  show: boolean;
...
export default function StockTypeModal({
  show,
  isCreateMode,
  selectedStockType,
  activeTab,
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            {isCreateMode ? 'Create Stock Type' : 'Edit Stock Type'}
          </h2>
          <button
            onClick={onClose}
            style={{
        ...
        <div>
          ...
          {activeTab === 'approval' && !isCreateMode && selectedStockType && (
            <div>
              <div className="mb-5">
                {(selectedStockType.status === StatusEnum.FOR_APPROVAL || selectedStockType.status === StatusEnum.NEW_RECORD) && (
                ...
                {selectedStockType?.forApprovalVersion ? (
                  <div style={{
                    ...
                    {/* Stock Type Name */}
                    {selectedStockType.forApprovalVersion.stockTypeName !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        ...
                        <input
                          type="text"
                          value={String(selectedStockType.forApprovalVersion.stockTypeName)}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {/* Status */}
                    {selectedStockType.forApprovalVersion.status !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        <label style={{
                          display: 'block',
                          fontSize: '14px',
                        ...
                        <input
                          type="text"
                          value={String(selectedStockType.forApprovalVersion.status)}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
