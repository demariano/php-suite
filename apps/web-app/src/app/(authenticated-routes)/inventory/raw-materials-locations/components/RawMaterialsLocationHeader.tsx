...
interface RawMaterialsLocationHeaderProps {
    searchQuery: string;
    statusFilter: string;
...
export default function RawMaterialsLocationHeader({
    searchQuery,
    statusFilter,
    onSearchChange,
    ...
    canCreate = true,
    isAdminUser = false,
}: RawMaterialsLocationHeaderProps) {
    return (
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex w-full items-center gap-3 sm:flex-1">
                    ...
                    <div className="flex-1">
                        <Input
                            placeholder="Search raw materials locations"
                            value={searchQuery}
