...
export default function EditRawMaterialsLocationPage({ params }: { params: { rawMaterialsLocationId: string } }) {
    ...
    const handleApprove = async () => {
        ...
        try {
            setIsSaving(true);
            await RawMaterialsLocationApi.approveRawMaterialsLocation(
                selectedLocation.rawMaterialsLocationId,
                userRole
            );
            setFlashNotification({
    ...
    const handleDenyConfirm = async (reason: string) => {
        ...
        try {
            ...
            const message = extractErrorMessage(
                err,
                'Failed to deny raw materials location changes. Please try again.'
            );
            setFlashNotification({
                title: 'Error',
                message,
        ...
        <div className="p-4 sm:p-6 space-y-6">
            ...
            <div>
                <nav className="flex items-center gap-2">
                    ...
                    <span className="text-gray-400">/</span>
                    <a
                        href="/inventory/raw-materials-locations"
                        className="text-blue-500 no-underline text-sm hover:text-blue-600 transition-colors duration-200"
                    >
                                            ...
                                            <div className="rounded-xl border-2 border-gray-200 p-4 sm:p-6">
                                                <div className="mb-4 flex items-center gap-3">
                                                    ...
                                                    <h3 className="text-base font-bold text-blue-600">
                                                        Raw Materials Location Information
                                                    </h3>
                                                </div>
                                                ...
                                                <div className="grid grid-cols-1 gap-6">
                                                    {showApprovalUI ? (
                                                        renderFieldWithInlineDiff(
                                                            'Location Name',
                                                            selectedLocation.rawMaterialsLocationName,
                    ...
                    <div className="bg-white rounded-xl p-6 w-full max-w-md shadow-lg space-y-6">
                        <div className="flex items-center gap-3">
                            ...
                            <h3 className="text-lg font-semibold text-gray-800 m-0">
                                Deny Raw Materials Location Changes
                            </h3>
                        </div>
