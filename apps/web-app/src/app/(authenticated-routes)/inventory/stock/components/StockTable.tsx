    ...
    return (
        <>
            ...
            <div className="hidden sm:block bg-white border border-gray-200 rounded-xl overflow-hidden shadow-lg">
                {isLoading ? (
                    <div className="p-10 text-center text-gray-500 text-base">Loading stock...</div>
                ) : (
                                ...
                                {tableData.length > 0 ? (
                                    tableData.map((stock) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-5 text-sm text-gray-600">{stock.lotNo || '-'}</td>
                                            ...
                                            <td className="px-6 py-5">{stock.status}</td>
                        ...
                        tableData.map((stock) => (
                            ...
                            >
                                ...
                                <dl className="mt-4 grid grid-cols-2 gap-3 text-sm text-gray-700">
                                    <div>
                                        <dt className="font-medium text-gray-500">Total Qty</dt>
                                        <dd className="text-gray-900">{stock.totalQuantity || 0}</dd>
                                    </div>
                                    <div>
