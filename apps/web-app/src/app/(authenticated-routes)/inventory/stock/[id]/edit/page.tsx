...
export default function EditStockPage({ params }: EditStockPageProps) {
  ...
  const handleSave = async (stock: StockDto) => {
    try {
      ...
      const updatedStock = await StockApi.updateStock(params.id, {
      ...
      <div className="space-y-6 animate-fadeIn rounded-xl border-2 border-blue-200 bg-white p-4 shadow-sm sm:p-6">
        ...
        <div className="space-y-4">
          <div className="border-2 border-gray-200 rounded-xl p-4 sm:p-6">
            ...
            {renderReadOnlyField('Expiration Date', approvalData.expirationDate, 'bg-blue-500', 'expirationDate')}
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="border-2 border-gray-200 rounded-xl p-4 sm:p-6">
            ...
            {renderReadOnlyField('Product Unit', approvalData.productUnitName, 'bg-blue-500', 'productUnitName')}
            {renderReadOnlyField('Stock Type', approvalData.stockTypeName, 'bg-blue-500', 'stockTypeName')}
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="border-2 border-gray-200 rounded-xl p-4 sm:p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {renderReadOnlyField('Quantity On Hand', approvalData.quantityOnHand, 'bg-blue-500', 'quantityOnHand')}
            {renderReadOnlyField('Available Quantity', approvalData.availableQuantity, 'bg-blue-500', 'availableQuantity')}
            </div>
          </div>
        </div>
