...
export default function StockMainPage() {
    ...
    const fetchStocks = async (direction?: 'next' | 'prev', cursor?: any, customPageSize?: number) => {
        try {
            ...
            if (searchTerm && searchTerm.trim() !== '') {
                ...
                response = await StockApi.getStocks(currentPageSize, direction, serializedCursor, userRole);
            }
    ...
    const handleRowClick = async (stock: StockDto) => {
        // Navigate to edit stock page
        window.location.href = `/inventory/stock/${stock.stockId}/edit`;
    };

    const handleCreateClick = () => {
        // Navigate to create stock page
        window.location.href = '/inventory/stock/create';
    };
        ...
        <div className="p-4 sm:p-6 space-y-6">
            ...
            <div>
                <nav className="flex items-center gap-2">
                    ...
                    <span className="text-gray-400">/</span>
                    <span className="text-gray-800 text-sm font-medium">Stock</span>
                </nav>
            </div>
