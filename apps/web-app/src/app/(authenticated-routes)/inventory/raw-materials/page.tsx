                  ...
                  tableData.map((row) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-5 text-sm">
                        {row.latestActivity ? (
                          <span
                            className={`px-2 py-1 rounded ${row.latestActivity.style.bgColor ?? ''} ${row.latestActivity.style.textColor ?? ''}`.trim()}
                          >
              ...
              >
                ...
                {row.latestActivity && (
                  <div className="mt-2">
                    ...
                    <dd>
                      <span
                        className={`px-2 py-1 rounded text-xs ${row.latestActivity.style.bgColor ?? ''} ${row.latestActivity.style.textColor ?? ''}`.trim()}
                      >
                        {row.latestActivity.text.length > 60
                          ? `${row.latestActivity.text.substring(0, 60)}...`
                          : row.latestActivity.text}
