        ...
        const fetchRawMaterial = async () => {
            ...
            try {
                ...
                if (
                    rawMaterial &&
                    (
                        [StatusEnum.FOR_APPROVAL, StatusEnum.NEW_RECORD, StatusEnum.FOR_DELETION] as StatusEnum[]
                    ).includes(rawMaterial.status || StatusEnum.ACTIVE) &&
                    isAdminUser
                ) {
                ...
                <div className="space-y-4">
                    <div className="rounded-xl border-2 border-gray-200 p-4 sm:p-6">
                        ...
                        <div className="grid grid-cols-1 gap-6">
                            ...
                            {renderReadOnlyField(
                                'Raw Material Unit',
                                approvalData.rawMaterialUnitName,
                                'bg-blue-500',
                                'rawMaterialUnitName'
                            )}
                        </div>
