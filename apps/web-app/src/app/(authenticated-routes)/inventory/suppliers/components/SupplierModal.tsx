      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            {isCreateMode ? 'Create Supplier' : 'Edit Supplier'}
          </h2>
          <button
            onClick={onClose}
            style={{
        ...
        <div>
          ...
          {activeTab === 'approval' && !isCreateMode && selectedSupplier && (
            <div>
              <div className="mb-5">
                {(selectedSupplier.status === StatusEnum.FOR_APPROVAL || selectedSupplier.status === StatusEnum.NEW_RECORD) && (
                ...
                {selectedSupplier?.forApprovalVersion ? (
                  <div style={{
                    ...
                    {/* Supplier Name */}
                    {selectedSupplier.forApprovalVersion.supplierName !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        ...
                        <input
                          type="text"
                          value={String(selectedSupplier.forApprovalVersion.supplierName)}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {/* Supplier Address */}
                    {selectedSupplier.forApprovalVersion.supplierAddress !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        <label style={{
                          display: 'block',
                          fontSize: '14px',
                        ...
                        <input
                          type="text"
                          value={String(selectedSupplier.forApprovalVersion.supplierAddress)}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {/* Supplier Phone */}
                    {selectedSupplier.forApprovalVersion.supplierPhone !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        <label style={{
                          display: 'block',
                          fontSize: '14px',
                        ...
                        <input
                          type="text"
                          value={String(selectedSupplier.forApprovalVersion.supplierPhone)}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {/* Supplier Email */}
                    {selectedSupplier.forApprovalVersion.supplierEmail !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        <label style={{
                          display: 'block',
                          fontSize: '14px',
                        ...
                        <input
                          type="text"
                          value={String(selectedSupplier.forApprovalVersion.supplierEmail)}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {selectedSupplier.forApprovalVersion.supplierContactPerson !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        <label style={{
                          display: 'block',
                          fontSize: '14px',
                        ...
                        <input
                          type="text"
                          value={String(selectedSupplier.forApprovalVersion.supplierContactPerson)}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                    ...
                    {/* Status */}
                    {selectedSupplier.forApprovalVersion.status !== undefined && (
                      <div style={{ marginBottom: '20px' }}>
                        <label style={{
                          display: 'block',
                          fontSize: '14px',
                        ...
                        <input
                          type="text"
                          value={String(selectedSupplier.forApprovalVersion.status)}
                          readOnly
                          style={{
                            width: '100%',
                            padding: '12px 16px',
