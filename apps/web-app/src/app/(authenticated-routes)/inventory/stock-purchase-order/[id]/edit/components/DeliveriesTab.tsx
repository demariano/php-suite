        ...
        purchaseOrderDetails.forEach((item) => {
            ...
            if (stats.deliverNow > 0) {
                ...
                if (stats.willExceed) {
                    errors[
                        item.productId
                    ] = `Cannot deliver more than ordered (${stats.orderedQty} ${item.productUnitName})`;
                    return;
                }
            }
        });
                                            ...
                                            <div className="flex items-center gap-4">
                                                <div>
                                                    ...
                                                    <p className="text-xs text-gray-500 mt-1">
                                                        {delivery.stockItems.length} item(s) -{' '}
                                                        {delivery.stockItems.reduce(
                                                            (sum, si) => sum + si.deliveredQty,
                                                            0
                                                        )}{' '}
                                                        total units
                                                    </p>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[1000]">
                    <div className="bg-white rounded-xl p-6 w-full max-w-md mx-4 shadow-lg">
                        ...
                        <p className="text-sm text-gray-600 mb-6 leading-relaxed">
                            ...
                            <br />
                            <br />
                            This will remove <strong>{deliveryToDelete.stockItems.length} item(s)</strong> from the
