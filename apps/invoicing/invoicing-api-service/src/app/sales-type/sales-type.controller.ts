...
export class SalesTypeController {
    ...
    @Post()
    @ApiOperation({
        summary: 'Create sales type',
        description: 'Creates a new sales type record',
    })
    @ApiQuery({
        name: 'userRole',
        type: String,
    ...
    @ApiResponse({
        status: 201,
        description: 'Sales type created successfully',
        schema: {
            type: 'object',
            properties: {
                ...
                data: {
                    type: 'object',
                    properties: {
                        salesTypeId: { type: 'string', example: 'sales-type-123' },
                        salesTypeName: { type: 'string', example: 'Premium Sales' },
    ...
    @ApiResponse({
        ...
        schema: {
            ...
            properties: {
                ...
                message: { type: 'string', example: 'Sales type name already exists' },
            },
        },
    })
    create(
        @Body() createSalesTypeDto: CreateSalesTypeDto,
        ...
        return this.commandBus.execute(new CreateSalesTypeCommand(createSalesTypeDto, user));
    }

    @Put(':id')
    @ApiOperation({
        summary: 'Update sales type',
        description: 'Updates an existing sales type record',
    })
    @ApiParam({
        name: 'id',
        description: 'Sales type ID',
        example: 'sales-type-123',
    })
    @ApiQuery({
        name: 'userRole',
        type: String,
    ...
    @ApiResponse({
        status: 200,
        description: 'Sales type updated successfully',
        schema: {
            type: 'object',
            properties: {
    ...
    @ApiResponse({
        status: 404,
        description: 'Sales type not found',
        schema: {
            type: 'object',
            properties: {
                statusCode: { type: 'number', example: 404 },
                message: { type: 'string', example: 'Sales type not found' },
            },
        },
    })
    update(
        ...
        return this.commandBus.execute(new UpdateSalesTypeCommand(id, salesTypeDto, user));
    }

    @Delete(':id')
    @ApiOperation({
        summary: 'Delete sales type',
        description: 'Deletes a sales type record',
    })
    @ApiParam({
        name: 'id',
        description: 'Sales type ID',
    ...
    @ApiResponse({
        status: 200,
        description: 'Sales type deleted successfully',
        schema: {
            type: 'object',
            properties: {
                statusCode: { type: 'number', example: 200 },
    ...
    delete(@Param('id') id: string, @Query('userRole') userRole: string, @CurrentUser() user: UserCognito) {
        ...
        const salesTypeDto = new SalesTypeDto();
        return this.commandBus.execute(new DeleteSalesTypeCommand(id, salesTypeDto, user));
    }

    @Post(':id/approve')
    @ApiOperation({
        summary: 'Approve sales type',
        description: 'Approves a sales type change request',
    })
    @ApiParam({
        name: 'id',
        description: 'Sales type ID',
    ...
    @ApiResponse({
        status: 200,
        description: 'Sales type approved successfully',
        schema: {
            type: 'object',
            properties: {
                statusCode: { type: 'number', example: 200 },
    ...
    approve(@Param('id') id: string, @Query('userRole') userRole: string, @CurrentUser() user: UserCognito) {
        ...
        return this.commandBus.execute(new ApproveSalesTypeCommand(id, user));
    }

    @Post(':id/deny')
    @ApiOperation({
        summary: 'Deny sales type',
        description: 'Denies a sales type change request',
    })
    @ApiParam({
        name: 'id',
        description: 'Sales type ID',
    ...
    @ApiResponse({
        status: 200,
        description: 'Sales type denied successfully',
        schema: {
            type: 'object',
            properties: {
                statusCode: { type: 'number', example: 200 },
    ...
    @Get('name/:name')
    @ApiOperation({
        summary: 'Search sales types by name',
        description: 'Searches for sales types containing the specified name with pagination support',
    })
    @ApiParam({
        name: 'name',
    ...
    @ApiResponse({
        status: 200,
        description: 'Sales types found successfully with pagination',
        schema: {
            type: 'object',
            properties: {
                statusCode: { type: 'number', example: 200 },
    ...
    getByName(
        ...
        return this.queryBus.execute(new GetSalesTypeByNameQuery(name, limit, direction, cursorPointer));
    }

    @Get()
    @ApiOperation({
        summary: 'List sales types with pagination',
        description: 'Retrieves a paginated list of sales types with optional filtering',
    })
    @ApiQuery({
        name: 'limit',
        description: 'Number of records per page',
    ...
    @ApiResponse({
        status: 200,
        description: 'Sales types retrieved successfully',
        schema: {
            type: 'object',
            properties: {
                statusCode: { type: 'number', example: 200 },
    ...
    @Get('/status')
    @ApiOperation({
        summary: 'List sales types with pagination by status',
        description:
            'Retrieves a paginated list of sales types filtered by status. Use cursor-based pagination for optimal performance.',
    })
    ...
    @ApiResponse({ status: 200, description: 'Sales types retrieved successfully' })
    ...
    @Get(':id')
    @ApiOperation({
        summary: 'Get sales type by ID',
        description: 'Retrieves a sales type record by their unique identifier',
    })
    @ApiParam({
        name: 'id',
        description: 'Sales type ID',
    ...
    @ApiResponse({
        status: 200,
        description: 'Sales type retrieved successfully',
        schema: {
            type: 'object',
            properties: {
                statusCode: { type: 'number', example: 200 },
    ...
    getById(@Param('id') id: string) {
        // Note: Query endpoints don't have @CurrentUser() so role override is not applicable
        // This is kept for consistency in Swagger documentation
        return this.queryBus.execute(new GetSalesTypeByIdQuery(id));
    }
}
