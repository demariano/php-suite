...
export class DenyTerritoryManagerDto {
    @ApiProperty({
        description: 'Reason for denying the territory manager record',
        example: 'Territory manager information is incomplete or incorrect',
        minLength: 3,
    })
